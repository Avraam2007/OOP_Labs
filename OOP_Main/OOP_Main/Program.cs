    ...
    internal class Program {
        static void Main(string[] args) {
            try {
                ...
                firstSupplier.AddProductToCatalog(phone);
                firstSupplier.AddProductToCatalog(tshirt);

                secondSupplier.AddProductToCatalog(chair);
                secondSupplier.AddProductToCatalog(sofa);
                ...
                Order newOrder = new Order(123, admin.Id, listToOrder);
